...
export class ProjectslistComponent implements OnInit {
  projects: ManagerModel[] = [];
  filteredProjects: ManagerModel[] = [];
  isDetailsView = false;
  selectedProject: ManagerModel = {} as ManagerModel;
  managerId: number = 0;
  searchQuery: string = '';
  ...
  goToUpdateForm(projectId: number): void {
    this.router.navigate(['manager/updateprojects', projectId]); // Navigate to the route
  }
